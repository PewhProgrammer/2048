...
public class TTFE {
	 ...
	 *            (2) board-width (int)
	 *            (3) board-heigh (int)
	 *            (4) use-gui     ("true" for true otherwise false)*
	 *            (5) use-human   ("true" for true otherwise false)*
	 *
	...
	public static void main(String[] args) {
		...
		boolean useGUI = DEFAULT_USE_GUI;
		...
		// The fourth argument (if given) is the user interface choice.
		if (args.length > 4)
			useGUI = string2boolean(args[4]);

		// The fifth argument (if given) is the player choice.
		if (args.length > 5)
			useHuman = string2boolean(args[5]);

		// Create a random object that allows to get new random numbers with
		// the:
